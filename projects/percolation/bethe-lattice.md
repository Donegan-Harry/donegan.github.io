...
An infinite cluster exists provided that $u<1$. Our criteria for finding the threshold is then a matter of stability analysis of our non-linear recusion relation. In particular, if we let $f(u)=(1-p)+pu^{z-1}$ 
